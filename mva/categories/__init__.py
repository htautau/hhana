...
CATEGORIES = {
    ...
    'overlap': [ Category_Cut_VBF_MVA_VBF,
                 Category_Cut_Boosted_MVA_Boosted,
                 Category_Cut_Presel_MVA_Presel,
                 ],
    'overlap_details': [ Category_Cut_VBF_MVA_VBF,
